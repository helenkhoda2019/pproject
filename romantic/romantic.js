$(document).ready(function () {
    ...
    var instagramPic = function (location) {
        ...
        var accessToken = "&access_token=EAAGZAwK5rShUBAKPcaOZBB9gwLASg7ag1KCpLjIeyRVUWJS766MVxPEaR7GntHaAKueW70KK8Fdjy3DaVqJU64BZAUAlGJUa0sSDCENyZBnSpZCUPvZB3tdXbTmP65chtM6ZCyWPlwPwnyczwZB42WPIne5zmwhTcxIgkYc54ZCdPJmGF7S8DdsxHncr6HGSPymTMi8QXwNVu0WUZAPRZBZAb7dXUd1chz2uQjjFVDfZAd7tKBSrwhzyI1HS4"
            ...
            $.ajax({
                ...
                for (var i = 0; i < imageUrl.length; i++) {
                    ...
                    if (imageUrl[i].media_type === "IMAGE") {
                        ...
                        $("#images").prepend(chillnImageLocation1);
                    } else {
                        continue;
                    }
